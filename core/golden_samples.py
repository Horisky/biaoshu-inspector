...
def golden_report(key: str = "baseline") -> dict:
    findings = [
        ...
        },
        {
            ...
            "law_reference": "招标文件第二章投标人须知 3.2.3；第三章评标办法 3.1.3",
            "suggestion": (
...
def _to_twoissues(base: dict) -> dict:
    ...
    fmap["G-01"].update({
        ...
        "rule_reference": "最高投标限价5,732,400.00元，投标人的报价不得超过最高投标限价，否则其投标将被否决。",
        "bid_reference": "投标中3处报价均为580万：①一、投标函：愿意以人民币（大写 伍佰捌拾万元整）（¥5,800,000元）的投标报价；②六、报价表·投标一览表：大写 伍佰捌拾万元整／小写 5,800,000；③（二）投标一览表明细·投标报价（元）：5,800,000。",
        "law_reference": "招标文件第二章投标人须知前附表 3.2.4；第三章评标办法 2.1.2 符合性评审（2）投标报价超过最高投标限价的",
        "suggestion": "将投标报价下调至不超过最高投标限价5,732,400元后再投（投标函、投标一览表、投标一览表明细三处需同步修改）。",
        "actions": [],
        "score_impact": "否决项·报价超限即废标",
        "category": "价格策略",
        "rule_section": "第二章 投标人须知 · 3.2.4 最高投标限价",
        "location": "一、投标函；六、报价表·投标一览表；（二）投标一览表明细",
    })
